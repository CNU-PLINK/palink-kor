...
당신은 다음 설명에 해당하는 적절한 답변을 해야합니다. 답변으로 'answer', 'reason' 을 반드시 JSON 객체로 리턴하세요.(\'''로 시작하는 문자열을 생성하지 않는다. 전체는 150자 이내로 출력하시오)
...
-  다음 답변 제공 시 다음의 미달성된 퀘스트를 고려하여 제공해주세요. : {unachievedQuests} 
- 퀘스트 고려시 가장 앞에 있는 퀘스트를 가장 우선적으로 고려합니다.
